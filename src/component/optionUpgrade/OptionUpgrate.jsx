          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
                ...
                <span>Priority visibility in hiring feeds</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                ...
                <span>10x more visibility in inspiration feeds*</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                ...
                <span>Instant creative portfolio on your domain</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                ...
                <span>Enhanced profile presentation</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                ...
                <span>Showcase project work & case studies</span>
              </li>
            </ul>
            ...
            <p className="font-light text-gray-400 dark:text-gray-300">
              *Pros who post over 1 shots per month get 10x more views on
              average than non-Pro Players
            </p>
          </div>

          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">Vip Pro</h3>
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Grow your design business with 10x more shot visibility & premium
              features to showcase your work.
            </p>
